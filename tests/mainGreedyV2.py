...
class Problem:
    ...
    def input_data_modelA(self):
        ...
        ##! probably better to limit the number maximum
        ...
        ##! nb_max_non_ordering till 11 up to t50 seems to work fine, 8 / 10 for t100
        ...
        print()
        print("unique pairs allowed to superpose: ", self.unique_pairs_allowed_to_superpose)
        ...
        ##! 5 works fine for t20, t30, t40, t50 and t100 smaller ones
